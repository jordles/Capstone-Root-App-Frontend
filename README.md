...
* Utilizing Cloudinary to store uploaded images and videos, max file size is 500mb. 
* Ping our backend server to check if it is online and avoid wait time for initial login.
